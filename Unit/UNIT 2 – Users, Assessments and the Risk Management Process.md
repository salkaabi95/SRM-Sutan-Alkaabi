...
![Unit 2 Peer Response Screenshot](https://github.com/salkaabi95/SRM-Sutan-Alkaabi/blob/main/images/unit2-peer2.png)
...
Learning from Unit 2 directly informed my approach to the **risk assessment methodology** used in the team project. Specifically, it reinforced why risk assessments should be systematic and user-aware, considering inputs from multiple stakeholders when identifying critical assets and potential threats. This guided decisions on risk scoring and the categorisation of risks in the current business assessment, ensuring that assessment outputs were relevant to both technical and operational stakeholders involved in the project.
